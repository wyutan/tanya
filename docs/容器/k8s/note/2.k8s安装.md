...
and service account keys on each node and then running the following as root:
  ...
  kubeadm join 10.167.246.9:16443 --token abcdef.0123456789abcdef \
        --discovery-token-ca-cert-hash sha256:ba257ca734abaaf8737bd0fcecc9b9d1f1fe6624cd4c08cad047e50f8a29e6ed \
        --control-plane 

Then you can join any number of worker nodes by running the following on each as root:

kubeadm join 10.167.246.9:16443 --token abcdef.0123456789abcdef \
        --discovery-token-ca-cert-hash sha256:ba257ca734abaaf8737bd0fcecc9b9d1f1fe6624cd4c08cad047e50f8a2 --cri-socket
```
### 安装网络插件
...
f26261f40c5cfe059bf14f394771b1c50996f79a4f73d140f9ba7d
```
- 在其他master节点输入
```
```
