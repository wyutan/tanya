...
@media (min-width: 1200px) {
  ...
  .about-sidebar-col {
    ...
    top: 0;               /* 顶部对齐：0 代表和父容器顶部边缘对齐 */
    left: 50%;            /* 依然基于屏幕中心点 */
    margin-left: 420px;   /* 向右偏移：780/2 + 30 = 420px */
    width: 260px;
    z-index: 10;
  }
}
...
.gmail-link:hover { background-color: var(--vp-c-bg-mute); }
.icon-svg { width: 32px; height: 32px; display: block; }

.timeline-box { margin-left: 5px; }
.t-item {
  position: relative; padding-left: 24px; margin-bottom: 32px; 
