...
web服务器：apache
系统：RHEL8.7
mysql本地升级，mysql安装包下载请点击[mysql community](https://dev.mysql.com/downloads/mysql/)
zabbix模板需单独导入，[zabbix模板](ttps://git.zabbix.com/projects/ZBX/repos/zabbix/browse/templates)
:::
## 升级mysql
### 停止服务
```
